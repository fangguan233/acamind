...
class ChainlitDataLayer(BaseDataLayer):
    ...
    async def create_element(self, element: "Element"):
        ...
        ON CONFLICT (id) DO UPDATE SET
            "threadId" = COALESCE(EXCLUDED."threadId", "Element"."threadId"),
            "stepId" = COALESCE(EXCLUDED."stepId", "Element"."stepId"),
            metadata = COALESCE(EXCLUDED.metadata, "Element".metadata),
            mime = COALESCE(EXCLUDED.mime, "Element".mime),
            name = COALESCE(EXCLUDED.name, "Element".name),
            "objectKey" = COALESCE(EXCLUDED."objectKey", "Element"."objectKey"),
            url = COALESCE(EXCLUDED.url, "Element".url),
            "chainlitKey" = COALESCE(EXCLUDED."chainlitKey", "Element"."chainlitKey"),
            display = COALESCE(EXCLUDED.display, "Element".display),
            size = COALESCE(EXCLUDED.size, "Element".size),
            language = COALESCE(EXCLUDED.language, "Element".language),
            page = COALESCE(EXCLUDED.page, "Element".page),
