...
class BaseSession:
    ...
    def to_persistable(self) -> Dict:
        ...
        # Avoid persisting empty chat settings as it can unintentionally wipe
        # browser-local settings when users resume older threads.
        if self.chat_settings:
            user_session["chat_settings"] = self.chat_settings
        else:
            user_session.pop("chat_settings", None)
