...
export default function ChatSettingsModal() {
  ...
  const { updateChatSettings, clearHistory } = useChatInteract();
  ...
  const handleClearHistory = () => {
    const confirmed = window.confirm(
      'Delete all history? This action cannot be undone.'
    );
    if (!confirmed) return;
    ...
    const history = clearLocalThreadHistory();
    setThreadHistory(toThreadHistoryState(history));
  };
