...
import { ChainlitContext, IThread, useConfig } from '@chainlit/react-client';
...
export default function SearchChats() {
  ...
  }, [searchQuery, debouncedSearch, localHistoryEnabled]);

  if (localHistoryEnabled) return null;
