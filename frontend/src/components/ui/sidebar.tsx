...
const parseSidebarWidth = (raw: string): number => {
...
>(({ className, ...props }, ref) => {
  ...
  const onPointerDown = React.useCallback(
    (event: React.PointerEvent<HTMLButtonElement>) => {
      ...
      const side =
        target.closest<HTMLElement>('[data-side]')?.dataset.side === 'right'
          ? 'right'
          : 'left';
    ...
    [sidebarWidth, setSidebarWidth, state]
  );
