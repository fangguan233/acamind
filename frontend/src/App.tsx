...
import PendingMessageSender from './components/PendingMessageSender';
...
function App() {
  ...
  const { data, isReady, user } = useAuth();
  ...
  }, [userEnv, user, connect, isReady, chatProfileOk]);
  ...
  if (!configLoaded && user) return null;
